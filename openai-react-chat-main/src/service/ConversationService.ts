...
import { get, post, put, patch, del } from "../utils/axiosInstance";
...
class ConversationService {
  ...
  static async getConversationById(id: number): Promise<ChatMessage[] | undefined> {
    return await get<ChatMessage[]>('/conversation_messages/id');
  }
